...
function genQuote() { var randNum = Math.floor(Math.random() * 4) + 1; document.getElementById('quote').innerHTML = quotes[randNum];}
...
var quotes = [
  ...
  "\"Those who bring sunshine into the lives of others cannot keep it from themselves.\"<br> - James M. Barrie"
];
